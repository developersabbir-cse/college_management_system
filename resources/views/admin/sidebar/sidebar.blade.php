            ...
            <ul class="list-unstyled navbar__list">
                <li class="active has-sub">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list">
                        ...
                        <li>
                            <a href="index2.html">
                                <i class="fas fa-tachometer-alt"></i>Manage Department</a>
                        </li>
                    </ul>
                </li>
                <li class=" has-sub">
                    ...
                    <ul class="list-unstyled navbar__sub-list js-sub-list dropdown-content">
                        <li>
                        ...
                        <li>
                            <a href="{{ route('manage-student') }}">
                                <i class="fas fa-tasks"></i>Manage Student</a>
                        </li>
                    </ul>
                </li>
                <li>
